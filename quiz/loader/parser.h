...
typedef enum
{
	...
	PARSE_INVALID_UTF8	= 6,	/**< Ungültige UTF-8-Zeichenkette in einer Zeile */
	PARSE_INVALID_TIMEOUT	= 7,	/**< Ungültiger Timeout angegeben */
	PARSE_INVALID_ANSWER	= 8,	/**< Falsche Antwortzeile */
	PARSE_EMPTY		= 9	/**< Die Datei enthält keine Fragen */
} ParserStatus;
